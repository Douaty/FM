================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FM Project Overview
===============================================================================

The application wizard has created this FM application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FM application.
...
FM.h
    ...
    project specific headers and declares the CFMApp application class.
...
FMDlg.h, FMDlg.cpp - the dialog
    These files contain your CFMDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named FM.pch and a precompiled types file named StdAfx.obj.
