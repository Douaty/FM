================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestFM Project Overview
===============================================================================

The application wizard has created this TestFM application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TestFM application.
...
TestFM.h
    ...
    project specific headers and declares the CTestFMApp application class.
...
TestFMDlg.h, TestFMDlg.cpp - the dialog
    These files contain your CTestFMDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TestFM.pch and a precompiled types file named StdAfx.obj.
